...
const JunkRemovalMountlakeTerracePage = () => {
  return (
    <LocationPageLayout
      ...
      metaDescription="Same-day junk removal in Mountlake Terrace, WA from $99. Furniture, appliances, yard waste & more. Licensed & insured. Request a free quote fast."
      zipCodes={['98043']}
      neighborhoods={[
      ...
      localContent={[
        {
          ...
          paragraphs: [
            ...
            "Pricing is based on truck space and starts at $99 for a single item. We give you the total before loading."
          ]
        },
        {
