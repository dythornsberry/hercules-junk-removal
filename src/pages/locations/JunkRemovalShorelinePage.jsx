...
const JunkRemovalShorelinePage = () => {
  return (
    <LocationPageLayout
      ...
      metaDescription="Same-day junk removal in Shoreline, WA from $99. Furniture, appliances, yard waste & more. Licensed & insured local team. Request a free quote fast."
      ...
      localContent={[
        {
          ...
          paragraphs: [
            ...
            "Pricing starts at $99 for a single item and is based on the volume your stuff takes up in our truck. We give you the price before loading."
          ]
        },
        {
          ...
          paragraphs: [
            ...
            "Whether you're downsizing, handling an estate, preparing a rental unit for new tenants, or tackling that cluttered garage, Hercules handles the hauling. We donate usable items, recycle what we can, and dispose of the rest responsibly."
          ]
        }
      ]}
      popularServices={[
