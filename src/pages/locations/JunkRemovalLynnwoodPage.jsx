...
const JunkRemovalLynnwoodPage = () => {
  return (
    <LocationPageLayout
      ...
      metaDescription="Same-day junk removal in Lynnwood, WA from $99. Furniture, appliances, yard waste & more. Licensed & insured local crew. Request a free quote fast."
      ...
      localContent={[
        {
          ...
          paragraphs: [
            ...
            "We serve all of Lynnwood with same-day and next-day availability. Pricing starts at $99 for a single item and is based on truck space. We give you the price before loading.",
            "From old furniture and busted appliances to full garage cleanouts and post-renovation debris, we handle it all. Point at what goes and we load it."
          ]
        },
        {
